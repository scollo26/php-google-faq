<?php 
    $faqs=[
        ...
        [
            "title" => "<h3>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h3>",
            "responses" => "<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
        ...
        [
            "title" => "<h3>Perché il mio account è associato a un paese?</h3>",

            "responses" => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                    <ol>
        ...
        [
            "title" => "<h3>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h3>", 
            "responses" => "<p>I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori di ricerca non possono rimuovere i contenuti direttamente dai siti web, quindi rimuovere risultati di ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web, devi. <a href='#'>contattare il webmaster </a>del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google,
...
<div class="header">
    ...
    <div class="nav">
        <ul>
            <li> <a class="testo" href="#">Introduzione</a> </li>
